from src.app import check_document_existance, get_doc_owner_name, get_all_doc_owners_names, add_new_shelf, delete_doc, get_doc_shelf, show_all_docs_info, add_new_doc
import pytest
